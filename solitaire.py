...
class MyGame(arcade.Window):
    ...
    def setup(self):
        ...
        # List pf cards we are dragging with the mouse
        self.held_cards = []
    ...
    def pull_to_top(self, card: arcade.Sprite):
        """Pull card to the top of rendering order (last to render, looks on-top)"""
    ...
    def on_mouse_release(self, x: float, y: float, button: int,
        ...
        # If we don't have any cards, doesn't matter
        ...
        # Release on top play pile? And onle one card held?
        if reset_position:
            # Whereover we were dropped, it wasn't valid
            # Reset each card's position to its original spot
